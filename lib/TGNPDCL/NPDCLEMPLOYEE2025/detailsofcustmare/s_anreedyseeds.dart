...
class detailsanreedyseeds extends StatefulWidget {
  const detailsanreedyseeds({super.key});

  @override
  State<detailsanreedyseeds> createState() => _detailsanreedyseedsState();
}

class _detailsanreedyseedsState extends State<detailsanreedyseeds> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text('CTMT20250803003897',
            style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18),),
            Text('M/s.A.N.REDDY SEEDS',style: TextStyle(color: Colors.white,fontSize: 14),)
          ],
        ),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            ...List.generate(data.length, (index){
              final bool isNum =_isNumeric(data[index]);
              return Column(
                children: [
                  Padding(
