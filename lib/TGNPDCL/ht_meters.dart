...
class HtMeters extends StatefulWidget {
  const HtMeters({super.key});

  @override
  State<HtMeters> createState() => _HtMetersState();
}

class _HtMetersState extends State<HtMeters> {
...
// SECTION DETAILS
  ...
  final List<String> selectsubdivision = ['SELECT', 'KAZIPET', 'HANAMKONDA', 'NAYEEMNAGAR'];
    ...
    final List<String> serviceno=['SELECT','HNK439 HNK439','NKH 132 NKH 132'];

  // WORK DETAILS
  String? work ='Cable Change';
  final List<String> workdetails=['Cable Change','Phase down Rectification', ' phase down-Meter Replaced',' No Display-Meter Replaced','Meter Burnt-Meter Replaced',
  'Meter Burnt-Meter(NO Display) Replaced','Meter Defective-Meter Replaced','CTPT Defective-CTOT Replaced',];
    ...
    child: Column(
      ...
      children: [
        ...
        DropdownButton( 
          isExpanded: true,
          value: work,
          items: workdetails.map((String alldetails){
            return DropdownMenuItem(
              value: alldetails,
              child: Text(alldetails));
          }).toList(), 
          onChanged: (String? displaydetails){
            setState(() {
              work=displaydetails;
            });
          }),
...
Visibility(
  visible: work!= null && work!.contains('Replaced'),
  child:Column(
    children: [
      Card(
      child: Padding(
  ...
  child: Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        // ✅ If checkbox is selected, show solar meter data only
        if (_newmeterdetails) ...[
          buildnewMeter('IMPORT KWH'),
          buildnewMeter('EXPORT KWH'),
          buildnewMeter('IMPORT KVAH'),
          buildnewMeter('EXPORT KVAH'),
          buildnewMeter('IMPORT MD'),
          buildnewMeter('EXPORT MD'),
          buildnewMeter('TOD 1 KVAH'),
          buildnewMeter('KWH ERROR %'),
          SizedBox(
            height: 5,
          ),
          Row(
  ...
  child: Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        style: TextStyle(
           fontWeight: FontWeight.bold ,
         color: const Color.fromARGB(255, 67, 54, 190),
        ),),
        SizedBox(
          height: 6,
        ),
...
SizedBox(
  ...
  child: ElevatedButton(
    style: ElevatedButton.styleFrom(
      ...
      backgroundColor: const Color.fromARGB(255, 54, 31, 206),
...
Widget buildnewMeter(String label) {
  return Padding(
    padding: const EdgeInsets.symmetric(vertical: 4.0),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.start,
